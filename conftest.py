...
@pytest.fixture
def digest_authentication_page(page: Page) -> DigestAuthenticationPage:
    return DigestAuthenticationPage(page)

@pytest.fixture
def random_number_page(page: Page) -> RandomNumberPage:
    return RandomNumberPage(page)

@pytest.fixture
def flaky_test_page(page: Page) -> FlakyTestPage:
    return FlakyTestPage(page)
...
@pytest.fixture
def should_equal_page(page: Page) -> ShouldEqualPage:
    return ShouldEqualPage(page)
...
@pytest.fixture
def should_include_page(page: Page) -> ShouldIncludePage:
    return ShouldIncludePage(page)
...
class GuerillaMail:
    ...
    def wait_for_mail(self, timeout=30):
